	...
	return (
		<div>
			<Box>
				...
				<Button _hover={{ opacity: ".85" }} _focus={{ outline: "none" }}mt='7' textTransform='uppercase' bg='#26004d' color='white' fontSize='md' p='6'><Box mr='4'>Learn more</Box><IconContext.Provider value={{ color: "#e600e6" }}><FaArrowRight size={20}/></IconContext.Provider></Button>
			</Box>
		</div>
	);
};
