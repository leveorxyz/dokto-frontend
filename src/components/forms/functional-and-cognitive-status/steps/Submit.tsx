...
import useFunctionalAndCognitiveStatusAdd from "../../../../hooks/functionalAndCognitiveStatusAdd/useFunctionalAndCognitiveStatusAdd";
...
export default function Submit() {
  ...
  } = useFunctionalAndCognitiveStatusAdd({ ...data, ...{ patient_encounter: id } });
