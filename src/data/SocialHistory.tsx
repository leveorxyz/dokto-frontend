export const homeEnvironmentOptions = [
  ...
  { label: "Stairs Outside", value: "Stairs Outside" },
  { label: "Other", value: "Other" },
];

export const higherEducationOptions = [
...
export const tobaccoStatusOptions = [
  ...
  { label: "Smoker, current status unknown", value: "Smoker, current status unknown" },
  { label: "Unknown if ever smoked", value: "Unknown if ever smoked" },
  { label: "Heavy tobacco smoker", value: "Heavy tobacco smoker" },
  { label: "Light tobacco smoker", value: "Light tobacco smoker" },

];

export const tobaccoTypeOptions = [
...
export const tobaccoPacksPerDayOptions = [
  { label: "Less than half pack", value: "Less than half pack" },
  { label: "Half pack", value: "Half pack" },
  { label: "Less than 1 pack", value: "Less than 1 pack" },
  { label: "1 pack", value: "1 pack" },
  { label: "More than 1 pack", value: "More than 1 pack" },
